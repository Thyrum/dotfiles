...
local function bind(mode, default_opts)
	return function(lhs, rhs, opts)
		map(mode, lhs, rhs, vim.tbl_deep_extend("force", default_opts, opts or {}))
	end
end

local nnoremap = bind("n", { remap = false })
local inoremap = bind("i", { remap = false })
local vnoremap = bind("v", { remap = false })
