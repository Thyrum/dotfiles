...
if [ $(tty) = '/dev/tty1' ] && [ $XDG_SESSION_TYPE = 'tty' ]; then
	...
	MOZ_DBUS_REMOTE=1 WLR_NO_HARDWARE_CURSORS=1 MOZ_ENABLE_WAYLAND=1 QT_QPA_PLATFORM=wayland XDG_SESSION_TYPE=wayland XDG_CURRENT_DESKTOP=sway WLR_DRM_NO_MODIFIERS=1 _JAVA_AWT_WM_NONREPARENTING=1 GTK_USE_PORTAL=0 exec sway
fi
